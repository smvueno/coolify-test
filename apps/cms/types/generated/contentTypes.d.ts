...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Client portfolio case studies';
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Pages rendered by the page builder';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<
      ['blocks.hero', 'blocks.features', 'blocks.cta', 'blocks.rich-text']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSiteSite extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    seoDescription: Schema.Attribute.Text;
    seoTitleTemplate: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'{{title}} | {{siteName}}'>;
